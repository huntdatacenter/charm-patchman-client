...
SHELL := /bin/bash
# Charm variables
CHARM_NAME := patchman-client
CHARM_STORE_URL := cs:~huntdatacenter/patchman-client
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-patchman-client/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-patchman-client/issues
